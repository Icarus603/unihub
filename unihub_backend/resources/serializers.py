...
from .models import Category, Tag, Resource, Attachment, Comment
...
class ResourceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'download_count', 'comments', 'attachments'
        ]
...
class CommentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Comment
        fields = ['id', 'resource', 'user', 'content', 'parent_comment', 'created_at']
